...
function onClickButton(){
    if(buttonCounter == 0){
      ...
      "<center><img src='../mabataki/ra1.png' alt='ラーメンくん' /></center><div class='message'>「こんにちはだメン！今日は一信のことをいろいろ教えてほしいメン！」<a href='#' class='switch' onclick='onClickButton();'><u>▼</u></a></div>";
      buttonCounter++;
      ...
      document.getElementById("RewritingDiv").innerHTML =
      "<center><img src='../mabataki/ra1.png' alt='ラーメンくん' /></center><div class='message'>「おお！どっちもおいしそうだメン！ところでどうしてこの土地にお店を構えたんだメン？」<a href='#' class='switch' onclick='onClickButton();'><u>▼</u></a></div>";
      buttonCounter++;
      setTimeout(showmessage(), 5000);
    }
      ...
      document.getElementById("RewritingDiv").innerHTML =
      "<center><img src='../mabataki/ra1.png' alt='ラーメンくん' /></center><div class='message'>「最後に店長さんの一信への思いを教えてほしいメン！」<a href='#' class='switch' onclick='onClickButton();'><u>▼</u></a></div>";
      buttonCounter++;
      setTimeout(showmessage(), 5000);
    }
      ...
      document.getElementById("RewritingDiv").innerHTML =
      "<center><img src='../mabataki/ra1.png' alt='ラーメンくん' /></center><div class='message'>「店長さん、ありがとうだメン！また食べに来るメン！」<a href='#' class='switch' onclick='onClickButton();'><u>▼</u></a></div>";
      buttonCounter++;
      setTimeout(showmessage(), 5000);
    }
